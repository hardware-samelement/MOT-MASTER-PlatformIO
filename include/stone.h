...
class edit_data{
  ...
  String getWifiPas2(void);
  String getEditTextData(void);
  String getVoipId(void);
  String getVoipPass(void);
  String getVoipServer(void);
  String getContactId(void);
  String getContactName(void);
  bool getCRCstat(void);
  bool getslidFix(void);
};
...
void _stone_recive_free(const char* name);
...
String stone_getValue(void);
String stone_getType(void);
...
void set_enable(const char* m_name, const char* m_tf, ...);
